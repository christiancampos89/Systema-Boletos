<?php
   ...
   $vfornecedor = isset($_POST["txtfornecedor"]) ? $_POST["txtfornecedor"] : '' ;
            ...
            <div class="col-md-6 mb-3">
              <fieldset id="tipousu"><label>TIPO DE USUÁRIO</label>
                  <table >
                    ...
                    <tr>
                      <td><input type="radio" name="txttipo" onclick="mostradiv('divfornecedor')" value="fornecedor" id="tfornecedor" /></td>
                      <td><label for="tfornecedor">FORNECEDOR</label></td>
                    </tr>
                    <tr>
                      <td><input type="radio" name="txttipo" onclick="mostradiv('divfarmacia')" value="associado" id="tassociado" /></td>
...
// 1 - REGISTRO DOS DADOS ----------------------------------------------------            
  ...
  // 2 - VALIDAÇÃO DAS INFORMAÇOES SE ESTÃO VAZIAS OU NÃO NO PREENCHIMENTO!!!
    ...
    }else if($vtipo == 'fornecedor' && $vfornecedor == '0')
    {
    ...
    {
      $sql= "INSERT INTO usuarios VALUES (NULL, '$vnome', '$vusuario','$vsenha', '$vpermissao', '$vtipo', '$vfornecedor')";
